...
class FlutterConfigEnv {
  /// An instance of all environment variables
  late Map<String, dynamic> _variables;

  // Private Constructor
  FlutterConfigEnv._internal();

  // Instance of FlutterConfig
  static final FlutterConfigEnv _instance = FlutterConfigEnv._internal();

  static const MethodChannel _channel = MethodChannel('flutter_config_env');
